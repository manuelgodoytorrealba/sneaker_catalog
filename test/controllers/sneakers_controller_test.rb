...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference("Sneaker.count") do
      post sneakers_url, params: { sneaker: { brand: @sneaker.brand, colorway: @sneaker.colorway, condition: @sneaker.condition, currency: @sneaker.currency, description: @sneaker.description, model: @sneaker.model, price_cents: @sneaker.price_cents, published: @sneaker.published, size: @sneaker.size, sku: @sneaker.sku, slug: @sneaker.slug, stock: @sneaker.stock } }
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { brand: @sneaker.brand, colorway: @sneaker.colorway, condition: @sneaker.condition, currency: @sneaker.currency, description: @sneaker.description, model: @sneaker.model, price_cents: @sneaker.price_cents, published: @sneaker.published, size: @sneaker.size, sku: @sneaker.sku, slug: @sneaker.slug, stock: @sneaker.stock } }
